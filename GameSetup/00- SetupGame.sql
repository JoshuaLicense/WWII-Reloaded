...
DELETE FROM MultiUnitFormation_SlotEntries WHERE MultiUnitFormationType = 'MUFORMATION_CITY_STATE_ATTACK_FORCE' and PrimaryUnitType = 'UNITAI_ATTACK' and SecondaryUnitType = 'UNITAI_COUNTER';
...
UPDATE AIEconomicStrategies SET TechObsolete = 'TECH_BANKING' WHERE Type NOT IN (
	...
	'ECONOMICAISTRATEGY_TOO_MANY_UNITS'); -- Make some strategies obsolete

DELETE FROM AIEconomicStrategy_City_Flavors WHERE FlavorType IN ('FLAVOR_CULTURE', 'FLAVOR_DIPLOMACY', 'FLAVOR_ESPIONAGE', 'FLAVOR_EXPANSION', 'FLAVOR_GROWTH', 'FLAVOR_HAPPINESS', 'FLAVOR_WONDER') and Flavor > 0;
DELETE FROM AIEconomicStrategy_Player_Flavors WHERE FlavorType IN ('FLAVOR_CULTURE', 'FLAVOR_DIPLOMACY', 'FLAVOR_ESPIONAGE', 'FLAVOR_EXPANSION', 'FLAVOR_GROWTH', 'FLAVOR_HAPPINESS', 'FLAVOR_WONDER') and Flavor > 0;

UPDATE AIEconomicStrategies SET WeightThreshold = 100 WHERE Type = 'ECONOMICAISTRATEGY_LOSING_MONEY';
UPDATE AIEconomicStrategies SET TechPrereq = NULL;
UPDATE AIEconomicStrategies SET FirstTurnExecuted = 0;

UPDATE AICityStrategies SET TechObsolete = 'TECH_BANKING' WHERE Type NOT IN (
	'AICITYSTRATEGY_ORIGINAL_CAPITAL',
	'AICITYSTRATEGY_CAPITAL_UNDER_THREAT',
	'AICITYSTRATEGY_GOOD_AIRLIFT_CITY',
...
UPDATE AICityStrategies SET TechPrereq = NULL;	
DELETE FROM AICityStrategy_Flavors WHERE FlavorType IN ('FLAVOR_CULTURE', 'FLAVOR_DIPLOMACY', 'FLAVOR_ESPIONAGE', 'FLAVOR_EXPANSION', 'FLAVOR_GROWTH', 'FLAVOR_HAPPINESS', 'FLAVOR_WONDER') and Flavor > 0;
...
UPDATE Technologies SET AllowsDefensiveEmbarking = 1;
