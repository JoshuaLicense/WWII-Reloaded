...
local GetPersonnelTooltip = EUI.GetPersonnelTooltip
local GetMaterielTooltip = EUI.GetMaterielTooltip
local GetFuelTooltip = EUI.GetFuelTooltip
...
-- todo
		...
		-- WWII
		local iPersonnelPerTurn = city:GetYieldRateTimes100( YieldTypes.YIELD_PERSONNEL ) / 100
		Controls.PersonnelPerTurnLabel:LocalizeAndSetText( "TXT_KEY_CITYVIEW_PERTURN_TEXT", iPersonnelPerTurn )
		local iMaterielPerTurn = city:GetYieldRateTimes100( YieldTypes.YIELD_MATERIEL ) / 100
		Controls.MaterielPerTurnLabel:LocalizeAndSetText( "TXT_KEY_CITYVIEW_PERTURN_TEXT", iMaterielPerTurn )
		local iFuelPerTurn = city:GetYieldRateTimes100( YieldTypes.YIELD_FUEL ) / 100
		Controls.FuelPerTurnLabel:LocalizeAndSetText( "TXT_KEY_CITYVIEW_PERTURN_TEXT", iFuelPerTurn )
...
local g_toolTips = {
	...
	PersonnelBox = function()
		return SetToolTipString( GetPersonnelTooltip )
	end,
	MaterielBox = function()
		return SetToolTipString( GetMaterielTooltip )
	end,
	FuelBox = function()
		return SetToolTipString( GetFuelTooltip )
	end,
--
