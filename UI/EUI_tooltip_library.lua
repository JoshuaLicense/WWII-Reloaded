...
-- Personnel
local function GetPersonnelTooltip( city )

	if civ5_mode and OptionsManager.IsNoBasicHelp() then
		return GetYieldTooltipHelper( city, YieldTypes.YIELD_PERSONNEL )
	else
		return L"TXT_KEY_PERSONNEL_HELP_INFO" .. "[NEWLINE][NEWLINE]" .. GetYieldTooltipHelper( city, YieldTypes.YIELD_PERSONNEL )
	end
end
-- Materiel
local function GetMaterielTooltip( city )

	if civ5_mode and OptionsManager.IsNoBasicHelp() then
		return GetYieldTooltipHelper( city, YieldTypes.YIELD_MATERIEL )
	else
		return L"TXT_KEY_MATERIEL_HELP_INFO" .. "[NEWLINE][NEWLINE]" .. GetYieldTooltipHelper( city, YieldTypes.YIELD_MATERIEL )
	end
end
-- Fuel
local function GetFuelTooltip( city )

	if civ5_mode and OptionsManager.IsNoBasicHelp() then
		return GetYieldTooltipHelper( city, YieldTypes.YIELD_FUEL )
	else
		return L"TXT_KEY_FUEL_HELP_INFO" .. "[NEWLINE][NEWLINE]" .. GetYieldTooltipHelper( city, YieldTypes.YIELD_FUEL )
	end
end
...
function TT.GetPersonnelTooltip( ... ) return select(2, pcall( GetPersonnelTooltip, ... ) ) end
function TT.GetMaterielTooltip( ... ) return select(2, pcall( GetMaterielTooltip, ... ) ) end
function TT.GetFuelTooltip( ... ) return select(2, pcall( GetFuelTooltip, ... ) ) end
